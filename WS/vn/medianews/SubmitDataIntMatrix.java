...
public class SubmitDataIntMatrix {
    ...
    protected List<WS.vn.medianews.ArrayList> data;
     ...
     * {@link WS.vn.medianews.ArrayList }
     * 
     * 
     */
    public List<WS.vn.medianews.ArrayList> getData() {
        if (data == null) {
            data = new java.util.ArrayList<WS.vn.medianews.ArrayList>();
        }
        return this.data;
    }
